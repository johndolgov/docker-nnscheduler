...
import numpy as np
from src.sequential import get_model
from src.DQTS import get_model as get_dqts_model
from src.sequential import run_episode, test, run_dqts_episode, dqts_test
from src.ep_utils.draw_rewards import plot_reward_together, plot_heft_dqts_ours
from src.heft_interective import heft
from src.logger import setup_logger_all
from src.ep_utils.setups import parameter_setup, DEFAULT_CONFIG
...
parser.add_argument('--wfs-name', type=str, default='Epigenomics_100')
parser.add_argument('--is-test', type=bool, default=False)
parser.add_argument('--num-episodes', type=int, default=100000)
parser.add_argument('--logger', type=bool, default=True)
parser.add_argument('--run-name', type=str, default='Epigenomics_100_DQTS_OUR')
